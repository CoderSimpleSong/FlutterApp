/*
 * @Author: 宋佳 
 * @Date: 2022-06-13 09:15:51 
 * @Last Modified by: relax
 * @Last Modified time: 2022-06-13 09:19:20
 */

//json转模型地址  https://javiercbk.github.io/json_to_dart/
...
class MinePageModel {
  ...
  MinePageModel({this.args, this.headers, this.url});

  MinePageModel.fromJson(Map<String, dynamic> json) {
